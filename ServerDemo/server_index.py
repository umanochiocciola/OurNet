main = {
    ...
    'help': 'to connect to a server start client.py and input ip and port of the server.\nThen you can send a request to the server to get specific pages\nYou don\'t necessarily need the official client: you can use any socket client that allows to send personalized requests',
    'sub directory': {
        'index': 'lol\n[art][subsubdir]',
        'art': 'no.',
        'subsubdir': {
            'index': 'You can go as deep as you want with this trick',
            'easter egg': 'lol',
        },
    },
}

error_response = 'sorry, we don\'t have any page named like that :|'